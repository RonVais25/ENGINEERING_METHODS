...
public class Session {
    ...
    /** Creates an empty session with no connection or identity yet. */
    public Session() { }

    // Connection (set by the connection screen).
    /** The active server connection, or {@code null} before connecting. */
    ...
    /** The logged-in staff user (staff login), or {@code null}. */
    private UserDTO    user;     // staff login
    /** The logged-in visitor (visitor login-by-ID), or {@code null}. */
    private VisitorDTO visitor;  // visitor login-by-ID

    /** {@return the active connection, or {@code null} if not connected} */
    public ClientConnection getConnection() { return connection; }
    /** {@return the host the client connected to} */
    public String getHost()                 { return host; }
    /** {@return the port the client connected to} */
    public int getPort()                    { return port; }

    /**
     * Promotes a freshly probed connection into the session (connection screen).
     *
     * @param conn the opened connection to adopt
     * @param host the host it connects to
     * @param port the port it connects to
     */
     ...
     *
     * @param visitor the authenticated visitor
     */
    ...
    /** Closes the active connection, if any (called on logout/shutdown). */
